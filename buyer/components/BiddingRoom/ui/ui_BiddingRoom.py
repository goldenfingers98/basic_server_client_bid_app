...
class Ui_BiddingRoom(object):
    def setupUi(self, BiddingRoom):
        ...
        BiddingRoom.resize(700, 400)
        BiddingRoom.setMaximumSize(QSize(700, 400))
        ...
        self.gridLayout.addWidget(self.assetId, 0, 1, 1, 1)
        ...
        self.gridLayout.addWidget(self.AssetCurrentPrice, 3, 1, 1, 1)
        ...
        self.gridLayout.addWidget(self.assetStartingFrom, 2, 1, 1, 1)
        ...
        self.scrollAreaWidgetContents.setGeometry(QRect(0, 0, 404, 185))
        ...
        self.label_2 = QLabel(BiddingRoom)
        ...
        self.proposalValue = QSpinBox(BiddingRoom)
        self.proposalValue.setObjectName(u"proposalValue")
        self.proposalValue.setMinimumSize(QSize(100, 0))
        self.proposalValue.setMaximumSize(QSize(100, 16777215))
        self.proposalValue.setFont(font1)
        self.proposalValue.setMaximum(9999999)

        self.gridLayout_2.addWidget(self.proposalValue, 1, 1, 1, 1)

        self.label = QLabel(BiddingRoom)
        ...
        self.timeInput = QLabel(BiddingRoom)
